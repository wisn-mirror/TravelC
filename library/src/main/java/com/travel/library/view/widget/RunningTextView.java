...
import com.travel.library.utils.StringUtils;

import java.math.BigDecimal;
import java.text.DecimalFormat;

/**
 * Created by Wisn on 2018/6/9 下午10:10.
 */
public class RunningTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public RunningTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        duration = ta.getInt(R.styleable.NumberRunningTextView_duration, 1100);
        ...
        headText = ta.getString(R.styleable.NumberRunningTextView_headText);
        ta.recycle();
    }
    ...
    public void playMoneyAnim(String moneyStr) {
        ...
        try {
            ...
            ValueAnimator floatAnimator = ValueAnimator.ofObject(new BigDecimalEvaluator(), new BigDecimal(lastNumber), bigDecimal);
    ...
    public void playNumAnim(String numStr) {
        ...
        try {
            ...
            ValueAnimator intAnimator = new ValueAnimator().ofInt((int) lastNumber, finalNum);
