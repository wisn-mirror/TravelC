...
package com.travel.library.view.swipebacklayout;
...
public class ViewDragHelper {
    ...
    /**
     * Edge flag indicating that the left_white edge should be affected.
     */
    public static final int EDGE_LEFT = 1 << 0;

    /**
     * Edge flag indicating that the lib_right_white edge should be affected.
     */
    ...
    public static abstract class Callback {
         ...
         * @param left        New X coordinate of the left_white edge of the view
         ...
         * @param xvel          X velocity of the pointer as it left_white the screen in pixels
         *                      per second.
         * @param yvel          Y velocity of the pointer as it left_white the screen in pixels
         *                      per second.
         */
         ...
         * @param dx    Proposed change in position for left_white
         * @return The new clamped position for left_white
         */
    ...
    /**
     * Animate the view <code>child</code> to the given (left_white, top) position. If
     ...
     * @param finalLeft Final left_white position of child
    ...
    /**
     * Settle the captured view at the given (left_white, top) position. The
     ...
     * no further work to do to complete the movement.
     *
     * @param finalLeft Settled left_white edge position for the captured view
    ...
    /**
     * Settle the captured view at the given (left_white, top) position.
     *
     * @param finalLeft Target left_white position for the captured view
     ...
     *
     * @param minLeft Minimum X position for the view's left_white edge
     * @param minTop  Minimum Y position for the view's top edge
     * @param maxLeft Maximum X position for the view's left_white edge
