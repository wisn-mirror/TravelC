    ...
    public void activityCreated(){
        ...
        if(fragment.getUserVisibleHint()){
            ...
            if(parentFragment != null && !parentFragment.getUserVisibleHint()){
                if(DEBUG){
//                    LogUtilsLib.info(TAG, fragmentName + ": activityCreated, parent " + parentFragment.getClass().getSimpleName() + "is hidden, therefore hidden self");
                }
                    ...
                    for (Fragment childFragment : childFragmentList) {
                        if (childFragment instanceof UserVisibleCallback) {
                            ...
                            if (userVisibleCallback.isWaitingShowToUser()) {
                                if (DEBUG) {
//                                    LogUtilsLib.info(TAG, fragmentName + ": setUserVisibleHint, show child " + childFragment.getClass().getSimpleName());
                                }
                    ...
                    for (Fragment childFragment : childFragmentList) {
                        if (childFragment instanceof UserVisibleCallback) {
                            ...
                            if (childFragment.getUserVisibleHint()) {
                                if (DEBUG) {
//                                    LogUtilsLib.info(TAG, fragmentName + ": setUserVisibleHint, hidden child " + childFragment.getClass().getSimpleName());
                                }
                                userVisibleCallback.setWaitingShowToUser(true);
