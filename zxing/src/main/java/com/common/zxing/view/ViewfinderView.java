...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        detector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onDoubleTap(MotionEvent e) {
                if (cameraManager != null) cameraManager.doubleTagHandleZoom();
                return super.onDoubleTap(e);
            }

            @Override
            public boolean onSingleTapConfirmed(MotionEvent e) {
                if (cameraManager != null) cameraManager.handleFocusMetering(e);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            paint.setAntiAlias(true);
            canvas.drawText(getResources().getString(R.string.bottom_hint), width / 2, frame.top - (float) TEXT_PADDING_TOP * density, paint);
            ...
            switch (event.getAction() & MotionEvent.ACTION_MASK) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if ((newDist - oldDist) > 20) {
                        if (cameraManager != null) cameraManager.zoomOut();
                    } else if ((newDist - oldDist) < 20) {
                        if (cameraManager != null) cameraManager.zoom();
                    }
                    oldDist = newDist;
                    break;
            }
