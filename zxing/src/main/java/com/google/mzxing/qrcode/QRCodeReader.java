...
package com.google.mzxing.qrcode;
            ...
            if (activity != null && activity.isAutoEnlarged()) {
                ...
                if (frameRect != null) {
                    ...
                    if (parameters.isZoomSupported()) {
                        if (len <= frameWidth / 6) {
                            if (zoom == 0) {
                                zoom = (int) (maxZoom / 1.8);
                            } else if (zoom <= maxZoom - 12) {
                                zoom = zoom + 12;
                            } else {
                                zoom = maxZoom;
                            }
                            ...
                            camera.setParameters(parameters);
                            return null;
                        } else if (len <= frameWidth / 4) {
                            if (zoom == 0) {
                                zoom = (int) (maxZoom / 2.5);
